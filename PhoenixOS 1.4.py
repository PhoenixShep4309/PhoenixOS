...
#guide
    ...
    print("4. app shortcuts are cap sensitive you can use all upercase first letter upercase and all lowercase words")
...
#tell me a joke
    ...
    if app_joke_pick == "1":
        ...
        input("what did the computer say to the user? (press ENTER) ")
