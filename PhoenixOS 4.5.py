...
#Find save file
file = os.path.isfile("PhoenixOS_4_5_Save.txt")
...
if file == False or file2 == False or file3 == False:
    ...
    if not file:
        print("! Main Save File Missing (PhoenixOS_4_5_Save.txt)")
    ...
    if missing == "QUIT" or missing == "quit" or missing == "Quit":
        ...
        if not file:
            file = open("PhoenixOS_4_5_Save.txt", "w")
            file.write("NONE\nNONE\nON\nON\n\nON\n100")
            file.close()
        if not file2:
...
def DateAndTime():
    ...
    return current_time
def read_line(line):
    file = open("PhoenixOS_4_5_Save.txt", "r")
    file = file.readlines()
    text = file[line-1]
    text = text.replace("\n", "")
    return text
def write_line(line, text):
    ...
    file = file.readlines()
    file[line-1] = text + "\n"
    old_file = open("PhoenixOS_4_5_Save.txt", "w")
    ...
    while not pygame_installed:
        ...
        if package_action == "":
            ...
            try:
                ...
                input("Erorr ocoured. Try again later")
            print("\n" * 100)
...
try:
    ...
    app_display = ("13 - " + custom_app_name)
    custom_app = True
except:
    app_display = ""
    custom_app = False
...
while True:
    ...
    if custom_app:
        print("! Custom app (" + custom_app_name + ") found. View settings for more info\n")
    ...
    if remind_home == "ON":
        ...
        if reminders == "":
            ...
            print(reminders)
            print()
    print(" 1 - Calculator             6 - Paintball    11 - Encryption")
    print(" 2 - Guess The Num/Word     7 - TicTacToe    12 - Settings")
    print(" 3 - Rock Paper Scissors    8 - Note         " + app_display)
    print(" 4 - Password Generator     9 - Reminders")
    print(" 5 - Timer                  10 - Contacts")
    print()
    app_open = input("Enter the number on the left of the app you want to open: ")
    LinePrint()
    ...
    #ENCRYPTION
        ...
        while True:
            ...
            encrypt_or_decrypt = input("Enter encrypt to encrypt your text. Enter decrypt to decrypt your text. Or just press enter to leave: ")
    ...
    #SETTINGS
        ...
        while settings_lock:
            ...
            if Setting_num == "dev":
                ...
                if dev_settings == "2":
                    LinePrint()
                    print("System Files: PhoenixOS_4_5_Save.txt, PhoenixOS_Contacts.txt, PhoenixOS_Reminders.txt")
            ...
            #custom apps
                ...
                if not custom_app:
                    ...
                    print("Developer: " + PhoenixOS_App.Dev())
                    print()
            ...
            #factory reset
                ...
                if reset_pass == password:
                    default_save = "NONE\nNONE\nON\nON\n\nON\n100"
                    contacts_write = open("PhoenixOS_4_5_Save.txt", "w")
