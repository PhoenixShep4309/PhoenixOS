...
#Find save file
file = os.path.isfile("PhoenixOS_4_2_Save.txt")
...
if file == False or file2 == False or file3 == False:
    ...
    if not file:
        print("! Main Save File Missing (PhoenixOS_4_2_Save.txt)")
    ...
    if missing == "QUIT" or missing == "quit" or missing == "Quit":
        ...
        if not file:
            file = open("PhoenixOS_4_2_Save.txt", "w")
            file.write("NONE\nNONE\nON\nON\n\nON\n100")
            file.close()
        if not file2:
...
def DateAndTime():
    ...
    return current_time
def read_line(line):
    file = open("PhoenixOS_4_2_Save.txt", "r")
    file = file.readlines()
    text = file[line-1]
    text = text.replace("\n", "")
    return text
def write_line(line, text):
    ...
    file = file.readlines()
    file[line-1] = text + "\n"
    old_file = open("PhoenixOS_4_2_Save.txt", "w")
...
if login == "ON" and first_time == False:
    print("PhoenixOS " + str(sys_os_version) + "\n")
...
while True:
    ...
    if remind_home == "ON":
        ...
        if reminders == "":
            ...
            print(reminders)
            print()
    print(" 1 - Calculator             5 - Timer        9 - Reminders")
    print(" 2 - Guess The Num/Word     6 - Paintball    10 - Contacts")
    print(" 3 - Rock Paper Scissors    7 - TicTacToe    11 - Encryption")
    print(" 4 - Password Generator     8 - Note         12 - Settings")
    print()
    ...
    #PASSWORD CREATOR
        ...
        app_pass_choose = input("Enter 1 for a code. Or enter 2 for a password: ")
        ...
        while settings_lock:
            ...
            #factory reset
                ...
                if reset_pass == password:
                    default_save = "NONE\nNONE\nON\nON\n\nON\n100"
                    contacts_write = open("PhoenixOS_4_2_Save.txt", "w")
